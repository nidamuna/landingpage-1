...
const Navbar2 = () => {
  ...
  return (
    <>
        <section className={navbar ? 'text-[#023047] hidden md:flex w-full bg-[#8ECAE6] h-auto py-4 px-8 justify-between items-start shadow-lg top-0' : 'hidden'}>
           ...
           <a href='#daftar'>
              <button className='bg-[#FB8500] hover:bg-[#FFB703] rounded-full text-white font-semibold p-2 shadow-md'>
                  Daftar Sekarang
              </button>
           </a>
        </section>
